...
import org.impactfin.mobilebanking.models.templates.account.AccountType;
...
public class QrCodeGenerator {
     ...
     * @param accountType {@link org.impactfin.mobilebanking.ui.enums.AccountType} i.e. SAVINGS or LOAN
    ...
    public static String getAccountDetailsInString(String accountNumber, String officeName,
                                                   org.impactfin.mobilebanking.ui.enums.AccountType
                                                           accountType) {
        int accountId = -1;
        if (accountType == org.impactfin.mobilebanking.ui.enums.AccountType.SAVINGS) {
            accountId = 0;
        } else if (accountType == org.impactfin.mobilebanking.ui.enums.AccountType.LOAN) {
            accountId = 1;
        }
